...
- 不要默认每段都先用一句断言或短判断句概括，再补解释、证据或例子，尤其避免反复以“问题在于成本。”“这种变化很重要。”一类小标题式句子起笔。段首如何展开取决于上下文，可以接续上文的人物、动作、条件或具体事实，让判断随论述展开；确有信息和推进作用的主题句、短句可以保留。不要仅把句号改成逗号、把结论机械移到段尾，或为变换起手式补写无来源的场景和细节。
